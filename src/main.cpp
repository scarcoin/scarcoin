...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // ScarCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ScarCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
        ...
        else if(nHeight < 200000)      
        {
                ...
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 999999);
        ...
        else if(nHeight < 300000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand2 = generateMTRandom(seed, 499999);
        ...
        else if(nHeight < 400000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand3 = generateMTRandom(seed, 249999);
        ...
        else if(nHeight < 500000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand4 = generateMTRandom(seed, 124999);
...
static const int64 nTargetTimespan = 3 * 60 * 60; // ScarCoin: every 3 hours
static const int64 nTargetSpacing = 45; // ScarCoin: 45 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // ScarCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal scarcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ScarCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "92 MILLION AMERICANS NOT IN LABOR FORCE";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // ScarCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
